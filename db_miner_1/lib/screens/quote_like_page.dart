      ...
      body: CustomScrollView(
        ...
        (i) => SliverList(
          delegate: SliverChildListDelegate([
            FutureBuilder(
                future: LikeDBHelper.likeDBHelper.fetchAllData(),
                                                  ...
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        QuoteEditingPage(
                                                            ...
                                                            image: BGProvider(
                                                                number: int.parse(data[index]["BGNum"].toString()))),
                                                  ));
                                            },
                                            highlightColor:
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              LikeDBHelper.likeDBHelper
                                                  .insertData(
                                                      quote: data[index]["quote"].toString(),
                                                      BGImage: int.parse(data[index]["BGNum"].toString()));
