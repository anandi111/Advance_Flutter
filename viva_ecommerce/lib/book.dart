                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            color: Colors.white,
                            child: Image.asset(
                                productListForBook[0]["Product Image"]),
                          ),
                          Text(
                            "\$${productListForBook[0]["Product Price"]}",
                            style: TextStyle(
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              productListForBook[0]["Product Name"],
                              style: TextStyle(
                                color: Color(0xff3065ef),
                                fontSize: 25,
                              ),
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Detail_page(
                                          image: productListForBook[0]
                                              ["Product Image"],
                                          name: productListForBook[0]
                                              ["Product Name"],
                                          price: productListForBook[0]
                                              ["Product Price"])));
                            },
                            child: Align(
                              alignment: Alignment.topLeft,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            color: Colors.white,
                            child: Image.asset(
                                productListForBook[1]["Product Image"]),
                          ),
                          Text(
                            "\$${productListForBook[1]["Product Price"]}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 20),
                          ),
                          SizedBox(
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              productListForBook[1]["Product Name"],
                              style: TextStyle(
                                color: Color(0xff3065ef),
                                fontSize: 25,
                              ),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Detail_page(
                                          image: productListForBook[1]
                                              ["Product Image"],
                                          name: productListForBook[1]
                                              ["Product Name"],
                                          price: productListForBook[1]
                                              ["Product Price"])));
                            },
                            child: Align(
                              alignment: Alignment.topLeft,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            color: Colors.white,
                            child: Image.asset(
                                productListForBook[2]["Product Image"]),
                          ),
                          Text(
                            "\$${productListForBook[2]["Product Price"]}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 20),
                          ),
                          SizedBox(
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              productListForBook[2]["Product Name"],
                              style: TextStyle(
                                color: Color(0xff3065ef),
                                fontSize: 25,
                              ),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Detail_page(
                                          image: productListForBook[2]
                                              ["Product Image"],
                                          name: productListForBook[2]
                                              ["Product Name"],
                                          price: productListForBook[2]
                                              ["Product Price"])));
                            },
                            child: Align(
                              alignment: Alignment.topLeft,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            color: Colors.white,
                            child: Image.asset(
                                productListForBook[3]["Product Image"]),
                          ),
                          Text(
                            "\$${productListForBook[3]["Product Price"]}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 20),
                          ),
                          SizedBox(
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              productListForBook[3]["Product Name"],
                              style: TextStyle(
                                color: Color(0xff3065ef),
                                fontSize: 25,
                              ),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Detail_page(
                                          image: productListForBook[3]
                                              ["Product Image"],
                                          name: productListForBook[3]
                                              ["Product Name"],
                                          price: productListForBook[3]
                                              ["Product Price"])));
                            },
                            child: Align(
                              alignment: Alignment.topLeft,
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            color: Colors.white,
                            child: Image.asset(
                                productListForBook[4]["Product Image"]),
                          ),
                          Text(
                            "\$${productListForBook[4]["Product Price"]}",
                            style: TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 20),
                          ),
                          SizedBox(
                          ...
                          Align(
                            alignment: Alignment.topLeft,
                            child: Text(
                              productListForBook[4]["Product Name"],
                              style: TextStyle(
                                color: Color(0xff3065ef),
                                fontSize: 25,
                              ),
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => Detail_page(
                                          image: productListForBook[4]
                                              ["Product Image"],
                                          name: productListForBook[4]
                                              ["Product Name"],
                                          price: productListForBook[4]
                                              ["Product Price"])));
                            },
                            child: Align(
                              alignment: Alignment.topLeft,
